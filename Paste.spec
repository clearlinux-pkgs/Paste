...
%prep
%setup -q -n Paste-3.4.0
cd %{_builddir}/Paste-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581526084
...
cp %{_builddir}/Paste-3.4.0/docs/license.txt %{buildroot}/usr/share/package-licenses/Paste/391729571488896efa70494919f96aab67116ad1
