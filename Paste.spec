...
Version  : 3.4.2
Release  : 71
URL      : https://files.pythonhosted.org/packages/d0/50/1db2fa746fa5e61207ab43a01d04fc4dbf2865229ccbed44899dec4499ec/Paste-3.4.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/d0/50/1db2fa746fa5e61207ab43a01d04fc4dbf2865229ccbed44899dec4499ec/Paste-3.4.2.tar.gz
...
%prep
%setup -q -n Paste-3.4.2
cd %{_builddir}/Paste-3.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594825014
...
cp %{_builddir}/Paste-3.4.2/docs/license.txt %{buildroot}/usr/share/package-licenses/Paste/391729571488896efa70494919f96aab67116ad1
