...
Version  : 3.4.6
Release  : 76
URL      : https://files.pythonhosted.org/packages/42/cf/95d27b8e7ee64304febaa9b828cda59dd5302cc94f1c35a92c3122b18019/Paste-3.4.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/42/cf/95d27b8e7ee64304febaa9b828cda59dd5302cc94f1c35a92c3122b18019/Paste-3.4.6.tar.gz
...
%prep
%setup -q -n Paste-3.4.6
cd %{_builddir}/Paste-3.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601314347
...
cp %{_builddir}/Paste-3.4.6/docs/license.txt %{buildroot}/usr/share/package-licenses/Paste/391729571488896efa70494919f96aab67116ad1
