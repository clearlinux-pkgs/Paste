...
export LANG=C
export SOURCE_DATE_EPOCH=1530328616
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/Paste
cp docs/license.txt %{buildroot}/usr/share/doc/Paste/docs_license.txt
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/Paste/docs_license.txt
